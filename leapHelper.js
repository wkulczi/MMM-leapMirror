  ...
  getGesture(gesture) {
    switch (gesture.type) {
      case "circle":
        ...
        return dotProduct > 0 ? 'circleClockwise' : 'circleCounterclockwise'
      case "keyTap":
        return 'keyTap'
      case "screenTap":
        return 'screenTap'
      case "swipe":
        ...
        if (isHorizontal) {
          return gesture.direction[0] > 0 ? 'swipeRight' : 'swipeLeft';
        } else { //vertical
          return gesture.direction[1] > 0 ? 'swipeUp' : 'swipeDown';
        }
    }
  },
